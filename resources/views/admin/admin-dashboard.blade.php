            ...
            <div id="voters" class="dashboard-section">
                <div class="table-container">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                        ...
                        <input type="text" class="search-input" placeholder="Search voters...">
                    </div>
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="action-btn btn-approve"><i class="fas fa-check"></i></button>
                                    <button class="action-btn btn-delete"><i class="fas fa-times"></i></button>
                                </td>
                            </tr>
                            <tr>
                                <td>#003</td>
                                ...
                                <td>
                                    <button class="action-btn btn-edit"><i class="fas fa-unlock"></i></button>
                                    <button class="action-btn btn-view"><i class="fas fa-info-circle"></i></button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
